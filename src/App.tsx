    ...
    <main className="bg-gray-100 flex flex-col items-center justify-center size-full font-anon">
      <div className="space-y-4 container p-8 w-fit overflow-y-auto">
        ...
        <p className="max-w-prose text-justify">
          ...
          Virginia Tech, I worked as a full stack web developer at Microsoft
          building the future of CRM with a lovely team. After a career break
          spent running, climbing, and skiing, I joined the world of startups
          with <A href="https://backdropbuild.com">Backdrop Build</A>. Here, I
          worked with <A href="https://github.com/nebolax">Alexey</A> on{" "}
          ...
          and a deploy a wallet for freelancers designed for effortless global
          payment.
        </p>
...
const A = ({ href, children }: { href: string; children: React.ReactNode }) => {
  return (
    <a
      ...
      className="text-amber-700 hover:text-amber-500 hover:underline underline-offset-2 transition-colors duration-100"
    >
      {children}
    </a>
  );
